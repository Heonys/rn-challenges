      ...
      <SafeAreaView className="w-full flex-1">
        ...
        >
          ...
          {loading || trendingLoading ? (
            ...
            <Text className="text-white">{error || trendingError}</Text>
          ) : (
            <View className="mt-5 flex-1">
              ...
              {trendingMovies && (
                <View className="mt-5">
                  <Text className="mb-3 text-lg font-bold text-white">Trending Moives</Text>
                  <FlatList
                    horizontal
                    ...
                    renderItem={({ item, index }) => <TrendingCard index={index} {...item} />}
                  />
                </View>
              )}
